...
export const Form = styled.View`
  flex: ${(props) =>
    props.isKeyVisible ? 0.7 : props.flexKeyIsHide ? props.flexKeyIsHide : 0.3};
...
export const Btn = styled(Button)`
  ...
  font-family: ${(props) => (props.fontType ? props.fontType : "PoppinsBold")};
  justify-content: center;
`;
...
export const Select = styled(SelectList)`
  border: solid red 1px;
`;
export const SelectWrapper = styled(ScrollView).attrs({
  alignItems: "center",
