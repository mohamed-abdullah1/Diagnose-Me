...
namespace MedicalServices.Persistence.Migrations
{
    ...
    [Migration("20230701165546_Adding-clinic-prop")]
    partial class Addingclinicprop
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MedicalServices.Domain.Entities.Allergy", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        ...
                        .HasDefaultValue(new DateTime(2023, 7, 1, 16, 55, 43, 958, DateTimeKind.Utc).AddTicks(8519));
            ...
            modelBuilder.Entity("MedicalServices.Domain.Entities.Check", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 7, 1, 16, 55, 43, 980, DateTimeKind.Utc).AddTicks(580));
            ...
            modelBuilder.Entity("MedicalServices.Domain.Entities.CheckFile", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 7, 1, 16, 55, 44, 34, DateTimeKind.Utc).AddTicks(304));
            ...
            modelBuilder.Entity("MedicalServices.Domain.Entities.Clinic", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 7, 1, 16, 55, 44, 69, DateTimeKind.Utc).AddTicks(7333));
            ...
            modelBuilder.Entity("MedicalServices.Domain.Entities.ClinicAddress", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 7, 1, 16, 55, 44, 43, DateTimeKind.Utc).AddTicks(7242));
            ...
            modelBuilder.Entity("MedicalServices.Domain.Entities.Disease", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 7, 1, 16, 55, 44, 86, DateTimeKind.Utc).AddTicks(1823));
            ...
            modelBuilder.Entity("MedicalServices.Domain.Entities.Doctor", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 7, 1, 16, 55, 44, 140, DateTimeKind.Utc).AddTicks(6221));
            ...
            modelBuilder.Entity("MedicalServices.Domain.Entities.Patient", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 7, 1, 16, 55, 44, 241, DateTimeKind.Utc).AddTicks(2836));
            ...
            modelBuilder.Entity("MedicalServices.Domain.Entities.Surgery", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 7, 1, 16, 55, 44, 375, DateTimeKind.Utc).AddTicks(7436));
            ...
            modelBuilder.Entity("MedicalServices.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 7, 1, 16, 55, 44, 395, DateTimeKind.Utc).AddTicks(4649));
