...
using MedicalServices.Application.MedicalServices.Checks.Queries.GetChecks;
...
public class CheckController : ApiController
{
    ...
    [Authorize]
    [HttpGet("check/get-checks/doctor-id/{doctorId}/page-number/{pageNumber}")]
    ...
    [Authorize]
    [HttpGet("check/get-checks/page-number/{pageNumber}")]
    public async Task<IActionResult> GetChecks(int pageNumber)
    {
