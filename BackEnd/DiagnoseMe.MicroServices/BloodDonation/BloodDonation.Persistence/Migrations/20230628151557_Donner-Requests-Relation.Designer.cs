...
namespace BloodDonation.Persistence.Migrations
{
    ...
    [Migration("20230628151557_Donner-Requests-Relation")]
    partial class DonnerRequestsRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BloodDonation.Domain.Entities.DonationRequest", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        ...
                        .HasDefaultValue(new DateTime(2023, 6, 28, 15, 15, 56, 585, DateTimeKind.Utc).AddTicks(5785));
            ...
            modelBuilder.Entity("BloodDonation.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 6, 28, 15, 15, 56, 609, DateTimeKind.Utc).AddTicks(3628));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BloodType = "A+",
                            CreatedOn = new DateTime(2023, 6, 28, 15, 15, 56, 609, DateTimeKind.Utc).AddTicks(6193),
                            FullName = "Patient",
                            Name = "Patient",
                            ProfilePictureUrl = ""
                        },
                        new
                        {
                            ...
                            BloodType = "A+",
                            CreatedOn = new DateTime(2023, 6, 28, 15, 15, 56, 609, DateTimeKind.Utc).AddTicks(6250),
                            FullName = "Doctor",
                            Name = "Doctor",
                            ProfilePictureUrl = ""
                        },
                        new
                        {
                            ...
                            BloodType = "A+",
                            CreatedOn = new DateTime(2023, 6, 28, 15, 15, 56, 609, DateTimeKind.Utc).AddTicks(6269),
                            FullName = "Admin",
                            Name = "Admin",
                            ProfilePictureUrl = ""
                        });
