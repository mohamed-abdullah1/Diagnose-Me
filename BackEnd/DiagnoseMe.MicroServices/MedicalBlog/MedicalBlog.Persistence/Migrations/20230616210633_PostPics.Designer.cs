...
namespace MedicalBlog.Persistence.Migrations
{
    ...
    [Migration("20230616210633_PostPics")]
    partial class PostPics
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MedicalBlog.Domain.Entities.Answer", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        ...
                        .HasDefaultValue(new DateTime(2023, 6, 16, 21, 6, 32, 750, DateTimeKind.Utc).AddTicks(6537));
            ...
            modelBuilder.Entity("MedicalBlog.Domain.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 6, 16, 21, 6, 32, 768, DateTimeKind.Utc).AddTicks(2980));
            ...
            modelBuilder.Entity("MedicalBlog.Domain.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 6, 16, 21, 6, 32, 777, DateTimeKind.Utc).AddTicks(9862));
            ...
            modelBuilder.Entity("MedicalBlog.Domain.Entities.PostImage", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 6, 16, 21, 6, 32, 785, DateTimeKind.Utc).AddTicks(6272));
            ...
            modelBuilder.Entity("MedicalBlog.Domain.Entities.Question", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 6, 16, 21, 6, 32, 804, DateTimeKind.Utc).AddTicks(2009));
            ...
            modelBuilder.Entity("MedicalBlog.Domain.Entities.Tag", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 6, 16, 21, 6, 32, 816, DateTimeKind.Utc).AddTicks(4991));
            ...
            modelBuilder.Entity("MedicalBlog.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 6, 16, 21, 6, 32, 817, DateTimeKind.Utc).AddTicks(7400));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 6, 16, 21, 6, 32, 886, DateTimeKind.Utc).AddTicks(5676),
                            FullName = "Patient",
                            Name = "Patient",
                            ProfilePictureUrl = ""
                        },
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 6, 16, 21, 6, 32, 886, DateTimeKind.Utc).AddTicks(5783),
                            FullName = "Doctor",
                            Name = "Doctor",
                            ProfilePictureUrl = ""
                        },
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 6, 16, 21, 6, 32, 886, DateTimeKind.Utc).AddTicks(5828),
                            FullName = "Admin",
                            Name = "Admin",
                            ProfilePictureUrl = ""
                        });
