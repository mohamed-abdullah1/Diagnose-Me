...
namespace MedicalBlog.Persistence.Migrations
{
    ...
    [Migration("20230619210126_RemoveProfileImageRequire")]
            ...
            modelBuilder.Entity("MedicalBlog.Domain.Entities.Answer", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        ...
                        .HasDefaultValue(new DateTime(2023, 6, 19, 21, 1, 26, 275, DateTimeKind.Utc).AddTicks(3935));
            ...
            modelBuilder.Entity("MedicalBlog.Domain.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 6, 19, 21, 1, 26, 289, DateTimeKind.Utc).AddTicks(7422));
            ...
            modelBuilder.Entity("MedicalBlog.Domain.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 6, 19, 21, 1, 26, 301, DateTimeKind.Utc).AddTicks(4763));
            ...
            modelBuilder.Entity("MedicalBlog.Domain.Entities.PostImage", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 6, 19, 21, 1, 26, 310, DateTimeKind.Utc).AddTicks(6219));
            ...
            modelBuilder.Entity("MedicalBlog.Domain.Entities.Question", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 6, 19, 21, 1, 26, 329, DateTimeKind.Utc).AddTicks(2038));
            ...
            modelBuilder.Entity("MedicalBlog.Domain.Entities.Tag", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 6, 19, 21, 1, 26, 341, DateTimeKind.Utc).AddTicks(5160));
            ...
            modelBuilder.Entity("MedicalBlog.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 6, 19, 21, 1, 26, 342, DateTimeKind.Utc).AddTicks(8478));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 6, 19, 21, 1, 26, 398, DateTimeKind.Utc).AddTicks(6897),
                            FullName = "Patient",
                            Name = "Patient",
                            ProfilePictureUrl = ""
                        },
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 6, 19, 21, 1, 26, 398, DateTimeKind.Utc).AddTicks(6961),
                            FullName = "Doctor",
                            Name = "Doctor",
                            ProfilePictureUrl = ""
                        },
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 6, 19, 21, 1, 26, 398, DateTimeKind.Utc).AddTicks(7014),
                            FullName = "Admin",
                            Name = "Admin",
                            ProfilePictureUrl = ""
                        });
