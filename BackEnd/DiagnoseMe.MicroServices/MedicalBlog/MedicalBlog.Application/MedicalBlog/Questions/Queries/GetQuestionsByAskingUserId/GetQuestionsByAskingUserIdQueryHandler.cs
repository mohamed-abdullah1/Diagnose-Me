...
public class GetQuestionsByAskingUserIdQueryHandler :  IRequestHandler<GetQuestionsByAskingUserIdQuery, ErrorOr<PageResponse>>
{
    ...
    public async Task<ErrorOr<PageResponse>> Handle(GetQuestionsByAskingUserIdQuery query, CancellationToken cancellationToken)
    {
